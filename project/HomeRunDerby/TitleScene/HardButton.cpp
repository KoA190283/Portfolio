...
HardButton::HardButton(TitleScene* pTitleScene)
{
	pTitleScene_ = pTitleScene;
}

//初期化
void HardButton::Initialize()
{
	//画像の読み込み
	const std::string	FILE_PATH		= ExternalDataManager::GetFilePathTitleSceneImage(ExternalDataManager::TITLE_SCENE_IMAGE::MODE_HARD);	//画像へのパス
...
void HardButton::Update()
{
	...
	//ゲームモードの設定
	InternalPlayDataReservoir::SetGameMode(ExternalDataManager::GAME_MODE::HARD);
